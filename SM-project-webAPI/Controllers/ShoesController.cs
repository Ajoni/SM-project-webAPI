...
namespace SMprojectWebAPI.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type,Size,Price,ImgurImageId")] Shoe shoe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Type,Size,Price,ImgurImageId")] Shoe shoe)
        {
            if (id != shoe.Id)
            {
                return NotFound();
